        ...
        public boolean setViewValue(View view, Cursor c, int columnIndex) {
            ...
            if (id == R.id.sudoku_board) {
                ...
                try {
                    ...
                    long id1 = c.getLong(c.getColumnIndex(SudokuColumns._ID));
                    Log.e(TAG, String.format("Exception occurred when deserializing puzzle with id %s.", id1), e);
                }
